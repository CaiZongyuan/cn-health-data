"""XLSX configuration and structural inspection."""
...
class WorkbookConfig(_ConfigModel):
    version: int
...
def inspect_workbook(snapshot: SourceSnapshot, config: WorkbookConfig) -> WorkbookInspection:
    ...
    try:
        ...
        return WorkbookInspection(
            snapshot, sheet_names, dimension, config.sheet.headers, data_rows, formula_cells
        )
    finally:
        workbook.close()
